        ...
        if(!empty($contactNo)){
            ...
            if (mysqli_connect_error()){
            	...
            	if($conn->query($sql)){
					...
					echo "<br><br><form action=Index.html><center><input class= 'btn' type='submit' value='Go Back'/><center></form></body>";
				}
				else{
			...
			echo "<br><br><form action=Index.html><center><input type='submit' value='Go Back'/><center></form></body>";
			die();
		    }
        	    }else{
